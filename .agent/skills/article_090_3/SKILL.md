---
name: "第九十条の三 （工事中における安全上の措置等に関する計画の届出）"
description: "建築基準法 第九十条の三（（工事中における安全上の措置等に関する計画の届出））の内容。 キーキーワード: > 第九十条の三 別表第一（い）欄の（一）項、（二）項及び（四）項に掲げる用途に供する建築物並びに地下の工作物内に設ける建築物で政令で定めるものの新築の工事又はこれらの建築物に係る避難施設等に関する工..."
---
