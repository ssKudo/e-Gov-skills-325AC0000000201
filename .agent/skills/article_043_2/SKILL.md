---
name: "第四十三条の二 （その敷地が四メートル未満の道路にのみ接する建築物に対する制限の付加）"
description: "建築基準法 第四十三条の二（（その敷地が四メートル未満の道路にのみ接する建築物に対する制限の付加））の内容。 キーキーワード: > 第四十三条の二 地方公共団体は、交通上、安全上、防火上又は衛生上必要があると認めるときは、その敷地が第四十二条第三項の規定により水平距離が指定された道路にのみ二メートル（前条第三項各号のいずれかに..."
---
