---
name: "第九条の四 （保安上危険な建築物等の所有者等に対する指導及び助言）"
description: "建築基準法 第九条の四（（保安上危険な建築物等の所有者等に対する指導及び助言））の内容。既存不適格建築物等の保安上危険な状態に対する指導・助言について規定しています。 キーワード: 指導、助言、保安上危険、特定行政庁、既存不適格"
---
