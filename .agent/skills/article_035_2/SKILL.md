---
name: "第三十五条の二 （特殊建築物等の内装）"
description: "建築基準法 第三十五条の二（（特殊建築物等の内装））の内容。 キーキーワード: > 第三十五条の二 別表第一（い）欄に掲げる用途に供する特殊建築物、階数が三以上である建築物、政令で定める窓その他の開口部を有しない居室を有する建築物、延べ面積が千平方メートルをこえる建築物又は建築物..."
---
